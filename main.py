...
class BiddingBot(commands.Bot):
    def __init__(self):
        super().__init__(command_prefix=commands.when_mentioned_or('.'), owner_ids=[503641822141349888, 1285079072946524200], intents=intents, activity=_activity, status=_status)
